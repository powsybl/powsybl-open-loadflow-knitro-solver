...
public class KnitroSolverParameters implements AcSolverParameters {
    ...
    // Specifies how the Hessian matrix is computed. 6 means that the Hessian is approximated using the L-BFGS method, which is a quasi-Newton method.
    public static final int DEFAULT_HESSIAN_COMPUTATION_MODE = 6;
